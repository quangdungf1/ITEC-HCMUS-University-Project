...
import 'schema/worksout_record.dart';
...
export 'schema/worksout_record.dart';
...
/// Functions to query WorksoutRecords (as a Stream and as a Future).
Future<int> queryWorksoutRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      WorksoutRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<WorksoutRecord>> queryWorksoutRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      WorksoutRecord.collection(parent),
      WorksoutRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<WorksoutRecord>> queryWorksoutRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
