...
class DetailsWidget extends StatefulWidget {
  const DetailsWidget({
    ...
    required this.videoInstruction,
    required this.steps,
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 10.0),
                                    child: Text(
                                      'How to do ${widget!.exercisesName}',
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                                            fontFamily: 'Outfit',
                                  ...
                                  Container(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final steps = widget!.steps!.toList();
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: RateExcompoWidget(
                                exRefs: widget!.ref!,
                                images: widget!.videoInstruction!,
                              ),
                            ),
                          );
                        },
